...
def app():
    ...
    if 'main_data.csv' not in os.listdir('data'):
        ...
        # Design column 1 
        y_var = col1.radio("Please Select the Target Variable (Y)", options=data.columns)

        # Design column 2 
        X_var = col2.multiselect("Please Select the Relevant Independent Variables", options=data.columns)
        ...
        st.write(f"**Select Target Variable:** {y_var}")
        st.write(f"**Select X Variables:** {X_var}")
